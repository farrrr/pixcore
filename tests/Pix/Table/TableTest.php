...
class Pix_Table_TableTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * 測試 getLink, 如果 Table 有指定應該要傳回 Table 指定的，沒有就是 default
     */
    ...
    public function testSearch()
    {
        ...
        $db->expects($this->once())
            ...
            ->will($this->returnValueMap(array(
                array($table, $search, '*', array(array('t1_id' => 3, 'value' => 'abc'))),
            )));
        ...
        $db->expects($this->once())
            ->method('fetch')
            ->will($this->returnValueMap(array(
                array($table, $search, '*', array(array('t1_id' => 5, 'value' => '5'))),
            )));
        ...
        $db->expects($this->once())
            ->method('fetchOne')
            ->will($this->returnValueMap(array(
                array($table, array(6), array('t1_id' => 6, 'value' => 'abc'))
            )));
        ...
        $db->expects($this->once())
            ->method('fetchOne')
            ->will($this->returnValueMap(array(
                array($table, array(7), array('t1_id' => 7, 'value' => 'abc'))
            )));
    ...
    public function testFind()
    {
        ...
        $db->expects($this->any())
            ->method('fetchOne')
            ->will($this->returnValueMap(array(
                array($table, array(1), null),
                array($table, array(2), array('t1_id' => 2, 'value' => 'abc')),
            )));
    ...
    {
        return self::returnCallback(function() use($map){
            $args = func_get_args();
            foreach ($map as $entry) {
                foreach ($args as $t1_id => $arg) {
                    if ($entry[$t1_id] != $arg) {
                        continue 2;
                    }
                }
            ...
            throw new Exception('no match variable');
        });
    }
    ...
    public function testCreateRow()
    {
        ...
        $db->expects($this->once())
            ->method('insertOne')
            ->will($this->returnValueMap(array(
                array($table, array('value' => 'default'), 11)
            )));
    ...
    public function testInsert()
    {
        ...
        $db->expects($this->once())
            ->method('insertOne')
            ->will($this->returnValueMap(array(
                array($table, array('value' => '999'), 12)
            )));
